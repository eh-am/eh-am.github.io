...
// findWeek finds, given a day, the monday/sunday corresponding to that week
// TODO: to find the biggest interval, we should find the next day and subtract the last minute?
//func (ad *ArticlesDigest) findWeek(date time.Time) string {
//	weekday := date.Weekday
//
//	monday := date.Sub(time.Day - weekday)
//}
